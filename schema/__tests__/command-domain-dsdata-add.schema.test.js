...
test("should throw without keytag", () => {
  expect(() =>
    schemaValidator.assert(
      {
        domain: "xn--yla.ro",
...
test("should throw without digest_type", () => {
  expect(() =>
    schemaValidator.assert(
      {
        domain: "xn--yla.ro",
...
test("should throw with invalid digest (non-existent option)", () => {
  expect(() =>
    schemaValidator.assert(
      {
        domain: "xn--yla.ro",
