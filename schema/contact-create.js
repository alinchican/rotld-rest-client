...
const inputSchema = schemaValidator
  ...
  .required()
  .keys({
    // name [string:utf-8] [mandatory]: the name of the person or
    // the company who holds the right of use for the domain name.
    ...
    // country_code[mandatory]: 2 chars country code according to ISO 3166-1-alpha-2 http://dev.rotld.ro/documents/iso-3166-2-code-countries-list
    ...
    fax: schemaValidator.string().required(),
